...
# 3 layers of neuron network, 1 hiding layer; 4 input,1 output
network = [4, [16], 1]
# variable of neuron network
population = 50
elitism = 0.2 
...
class NeuroNetwork():
	...
	# input:input layer neuron layers hiddens:hiding layer output:output neuron node
